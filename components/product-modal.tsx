...
import { X, Minus, Plus, Flame, AlertCircle, CheckCircle2, AlertTriangle, BarChart3, TrendingUp, ChevronRight, ChevronLeft, DollarSign } from "lucide-react"
...
function ImageSlider({ images }: { images: string[] }) {
  ...
  return (
    <div className="relative w-full h-48 md:h-64 bg-muted rounded-lg overflow-hidden shadow-xl border-2 border-white">
      <img
      ...
      <Button
        variant="outline"
        size="icon"
        className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/95 hover:bg-white shadow-lg z-20 border-2"
        onClick={prevImage}
      >
      ...
      <Button
        variant="outline"
        size="icon"
        className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/95 hover:bg-white shadow-lg z-20 border-2"
        onClick={nextImage}
      >
...
function ScrollableContent({ product, onClose }: ScrollableContentProps) {
  ...
  return (
    <div className="relative h-full overflow-hidden">
      ...
      {/* Fixed Image Slider */}
      <div className="absolute top-0 left-0 right-0 z-50 bg-gradient-to-b from-white via-white to-white/95 p-4 md:p-6 shadow-2xl">
